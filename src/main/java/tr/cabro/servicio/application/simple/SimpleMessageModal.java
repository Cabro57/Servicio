package tr.cabro.servicio.application.simple;
...
public class SimpleMessageModal extends SimpleModalBorder {
    ...
    public SimpleMessageModal(Type type, Component messageComponent, String title, Option[] optionType, ModalCallback callback) {
        super(messageComponent, title, optionType, callback);
        this.type = type;
    }
