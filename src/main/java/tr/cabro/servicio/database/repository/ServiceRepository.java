...
public interface ServiceRepository {
    ...
    @SqlBatch("INSERT INTO added_part (service_id, series_no, brand, name, supplier_id, device_type, model, amount, " +
            ...
            "VALUES (:serviceId, :serialNo, :brand, :name, :supplierId, :deviceType, :model, :amount, " +
    ...
    // Java modelinde 'serialNo' ve 'model' var, DB'de 'series_no' ve 'model' var.
    // BeanMapper'ın hatasız çalışması için 'AS' (Alias) kullanarak isimleri eşitliyoruz.
    @SqlQuery("SELECT id, service_id, series_no as serialNo, brand, name, supplier_id, device_type, model, " +
